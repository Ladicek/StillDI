...
class MethodInfoImpl extends DeclarationInfoImpl<java.lang.reflect.Executable, jakarta.enterprise.inject.spi.AnnotatedCallable<?>> implements MethodInfo {
    ...
    public List<ParameterInfo> parameters() {
        ...
        java.lang.reflect.Parameter[] parameters = reflection.getParameters();
    ...
    private Parameter[] enumConstructorHack(java.lang.reflect.Parameter[] parameters) {
        ...
        if (isConstructor()
            ...
            java.lang.reflect.Parameter[] declaredParameters = new Parameter[parameters.length - 2];
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MethodInfoImpl)) return false;
